...
export default function AdminDashboard() {
  ...
  const menuItems = [
    { key: '1', icon: <DashboardOutlined />, label: 'Dashboard', type: 'item' as const },
    { key: '2', icon: <ShoppingOutlined />, label: 'Orders', type: 'item' as const },
    { key: '3', icon: <CarOutlined />, label: 'Drivers', type: 'item' as const },
    { key: '4', icon: <EnvironmentOutlined />, label: 'Live Tracking', type: 'item' as const },
    { key: '5', icon: <TeamOutlined />, label: 'Clients', type: 'item' as const },
    { key: '6', icon: <DollarOutlined />, label: 'Payments', type: 'item' as const },
    { key: '7', icon: <UserOutlined />, label: 'Users', type: 'item' as const },
    { key: '8', icon: <SettingOutlined />, label: 'Settings', type: 'item' as const },
    { type: 'divider' as const },
    { key: 'logout', icon: <LogoutOutlined />, label: 'Logout', danger: true, type: 'item' as const },
  ];
